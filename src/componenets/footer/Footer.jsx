    ...
    >
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap md:text-left text-center order-first">
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            <img
              src="https://img.freepik.com/free-photo/credit-cards-that-are-stacked-floor_1150-16381.jpg?t=st=1729500619~exp=1729504219~hmac=fd5c8436bf08056a63b7392b21b88338758fb153f20d884f97e91faccf514bd7&w=1380"
              alt=""
            />
          </div>
        </div>
      ...
      >
        <div className="container px-5 py-3 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            <a className="text-gray-500" href="https://twitter.com">
              <svg
                fill="currentColor"
                strokeLinecap="round"
